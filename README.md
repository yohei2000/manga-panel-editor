...
React + TypeScript + Vite + Konva / Three.js で動く、ブラウザ完結の漫画制作補助アプリです。
...
上部の `ネーム` タブで、3D人形を使った構図設計モードに切り替えます。人物の位置、向き、ポーズ、カメラプリセット、吹き出し位置、生成指示を設定できます。
